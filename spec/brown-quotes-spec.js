...
import BrownQuotes from '../lib/brown-quotes';
...
describe('BrownQuotes', () => {
  ...
  describe('when the brown-quotes:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      // has been created
      expect(workspaceElement.querySelector('.brown-quotes')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.brown-quotes')).toExist();

        let brownQuotesElement = workspaceElement.querySelector('.brown-quotes');
        expect(brownQuotesElement).toExist();
